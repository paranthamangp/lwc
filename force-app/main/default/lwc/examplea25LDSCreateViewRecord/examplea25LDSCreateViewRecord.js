...
export default class Examplea25LDSCreateViewRecord extends LightningElement {
    ...
    /*
    @wire(getRecord, { recordId: '0012x00000EJMDgAAP', fields: [NAME_FIELD, PHONE_FIELD], optionalFields: [WEBSITE_FIELD] })
    account;
    */
